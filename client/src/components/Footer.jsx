...
const Footer = () => {
  return (
    <footer class="bg-gray-100 rounded-md">
      <div class="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24">
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-3 ">
          <div>
            <div class="flex justify-center text-[##a78bfa] sm:justify-start">
              <div>
            ...
            <p class="mt-6 max-w-md text-center leading-relaxed text-gray-500 sm:max-w-xs sm:text-left">
              We are Computer Customs store in Mumbai
            </p>
            ...
            <ul class="mt-8 flex justify-center gap-6 sm:justify-start md:gap-8">
              <li>
                <a
                  ...
                  rel="noreferrer"
                  target="_blank"
                  class="text-[##a78bfa] transition hover:text-teal-700/75"
                >
              ...
              <ul class="mt-8 space-y-4 text-sm">
                ...
                <li>
                  ...
                  >
                    ...
                    <span class="flex-1 text-gray-700">0123123123</span>
                  </a>
                </li>
                ...
                <li class="flex items-start justify-center gap-1.5 ltr:sm:justify-start rtl:sm:justify-end">
                  ...
                  <address class="-mt-0.5 flex-1 not-italic text-gray-700">
                    213 Lane, Lamington road, Mumbai
                  </address>
                </li>
              </ul>
            </div>
        ...
        <div class="mt-12 border-t border-gray-100 pt-6">
          <div class="text-center sm:flex sm:justify-between sm:text-left">
            <p class="text-sm text-gray-500">
              ...
              <a
                class="inline-block text-[##a78bfa] underline transition hover:text-teal-600/75"
                href="/"
              >
                Terms & Conditions
              </a>
