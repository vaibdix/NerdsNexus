export const isActiveStyles =
  " text-xl text-[#014558] font-semibold hover:text-red-700 px-4 py-2 duration-100 transition-all ease-in-out";
...
export const isNotActiveStyles =
  ...
  " text-xl text-[#d8fc6f] font-semibold hover:text-[#d8fc6f] px-4 py-2 duration-100 transition-all ease-in-out";

export const isNotActiveStylesDash =
  " text-xl text-white hover:text-[#d8fc6f] duration-100 px-4 py-2 transition-all ease-in-out";

export const statuses = [
  { id: 1, title: "Cabinet", category: "drinks" },
  { id: 2, title: "Monitors", category: "deserts" },
  { id: 3, title: "Cooler", category: "fruits" },
  { id: 4, title: "Cables", category: "rice" },
  { id: 5, title: "Keyboards", category: "curry" },
  { id: 6, title: "Motherboard", category: "chinese" },
  { id: 7, title: "SMPS", category: "bread" },
];
